...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=30, help='The epochs in training')
    ...
    parser.add_argument('--log_step', type=int, default=30, help='The interval of displaying the loss and perplexity')
